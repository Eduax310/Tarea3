...
export default function StarbucksRewards({ navigation }) {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.name}>[espacio]</Text>
